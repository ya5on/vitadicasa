var $ = jQuery, wind = jQuery(window), body = jQuery("body"), dsnGrid = {
    backgroundPosition: function (e, n, t) {
        ...
        return e instanceof jQuery == !1 && (e = jQuery(e)), t = this.getUndefinedVal(t, {}), o = this.getUndefinedVal(t.sizeX, "105%"), i = this.getUndefinedVal(t.sizeY, "105%"), s = this.getUndefinedVal(t.left, "-5%"), r = this.getUndefinedVal(t.top, "-5%"), a = this.getUndefinedVal(t.move, 100), e.css({
            ...
            var i = o.clientX / jQuery(this).width() - .5, s = o.clientY / jQuery(this).height() - .5;
        ...
        if (!(n.length <= 0)) {
            var i = n[0].getBoundingClientRect(), a = e.pageX - i.left, s = e.pageY - i.top,
        ...
        if (o <= s && void 0 !== t.action) {
            var l = o - s, c = l / d, f = s / (n.height() + o + i);
        ...
        var i = window.performance.timing, a = -1 * (i.loadEventEnd - i.navigationStart) / 1e3 % 50 * 10, s = e,
            r = n > e ? 1 : -1, d = Math.abs(Math.floor((a + t) / 100)), l = setInterval(function () {
                o(s += r), s >= n && clearInterval(l)
            }, d);
        return l
    }, embedVideo: function (e) {
        jQuery("[data-dsn-video]").each(function (e) {
            var n = jQuery(this), t = dsnGrid.removeAttr(n, "data-dsn-video");
            n.on("click", function () {
        ...
        e.on("mousemove", function (t) {
            ...
            var i = t.pageX, a = t.pageY - jQuery(this).offset().top;
            a > 0 && a < jQuery(this).height() && jQuery(this).offset().left < i && i < e.width() ? n.css({
                left: i,
                top: a
            }) : TweenMax.to(n, .5, {left: "50%", top: "50%"})
        ...
        var a = e, s = this;
        t = void 0 === t ? .5 : parseFloat(t), n = void 0 === n ? 20 : parseFloat(n), i = void 0 !== i && i;
        var r = a.html(), d = $('<div class="icon-circle"></div>'),
            l = $('<div class="dsn-grid-parallax">' + r + "</div>");
        a.html(""), a.append(d), a.append(l), a.on("mouseleave", function (e) {
            TweenMax.to(a, t, {scale: 1}), TweenMax.to(l, .3, {scale: 1, x: 0, y: 0}), TweenMax.to(d, t, {
                scale: 1,
                x: 0,
                y: 0
            })
        ...
        const n = $('[data-dsn-grid="progress-circle"]'), t = this.removeAttr(n, "data-dsn-grid-stroke");
        ...
        e.isScroller(!0) && (i = e.getScrollbar()), e.getListener(function (e) {
            let t = 0, o = $(document).height() - wind.height();
