...
!function (e) {
            ...
            return {
                main_root: e("main.main-root"), ajax_click: e("a.effect-ajax "), isEffectAjax: function () {
                    ...
                    let a = this, i = t.parents(".slide-content").data("dsn-id"),
                        o = e('.main-slider .slide-item[data-dsn-id="' + i + '"] .cover-bg').first(), s = n;
                    void 0 !== s && TweenMax.to(".project-metas , .nav-slider ,.footer-slid ,.view-all , .dsn-all-work ", .8, {
                        autoAlpha: 0,
                        scale: .8,
                        onComplete: function () {
                            o.removeClass("hidden"), o.find("img").addClass("hidden"), a.createElement(o, s, e(".root-slider"))
                        }
                    })
            ...
            return {
                initSlider: function () {
                    ...
                    return new Swiper(".main-slider .slide-inner", {
                        ...
                        pagination: {
                            el: ".main-slider .footer-slid .control-num span",
                            type: "custom",
                            clickable: !0,
    ...
    function a() {
        ...
        var a = document.querySelector("#custom-scrollbar");
        return {
            isMobile: function () {
                ...
                e && (a = document.querySelector("#custom-scrollbar"));
    ...
    var r = a(), l = function () {
        ...
        return {
            clearControl: function () {
                ...
                let a = e("#hero-parallax-img"), i = e("#dsn-hero-parallax-title"),
